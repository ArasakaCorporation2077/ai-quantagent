...
- alpha parsing, evaluation, and backtesting
- shipped SQLite alpha database

Not included:

- LLM alpha generation code
- research pipeline / idea generation workflow
- secrets, wallets, and internal handoff notes
